<!DOCTYPE html>
<html>
<link href="arka.png" rel="shortcut icon">
  <head>
    <meta charset="UTF-8">
	...
	<meta name="description" content="CAT ARKA Trans Psikologi">
	<meta name="keywords" content="CAT ARKA Trans Psikologi">
	<meta name="author" content="Muhammad Harry Setiawan">
    <!-- Bootstrap 3.3.4 -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-lg"><b>CAT ARKA</b></span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>&copy; 2022 IT ARKA TRANS PSIKOLOGI</strong>
      </footer>
