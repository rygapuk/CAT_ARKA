...
<section class="content-header">
	<h1>
		Pengaturan CAT ARKA Trans Psikologi
		<small>Melakukan pengaturan Identitas CAT ARKA Trans Psikologi</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url(); ?>/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Pengaturan CAT ARKA Trans Psikologi</li>
	</ol>
</section>
			...
			<?php echo form_open($url.'/simpan','id="form-pengaturan"'); ?>
                <div class="box">
                    <div class="box-header with-border">
    					<div class="box-title">Daftar Pengaturan CAT ARKA Trans Psikologi</div>
                    </div><!-- /.box-header -->
